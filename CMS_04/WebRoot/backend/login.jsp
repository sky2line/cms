...
<form id="login" action="LoginServlet" method="post">
  <div id="center">
    ...
    <div id="center_middle">
      ...
      <div class="user">
        <label>用户名：
        <input type="text" name="username" id="user" value="admin"/><!-- ${param.username } -->
        </label>
      </div>
      <div class="user">
        <label>密　码：
        <input type="password" name="password" id="pwd" value="admin"/><!-- ${param.password } -->
        </label>
      </div>
...
<div id="footer">日照职业技术学院微网科技有限公司</div>
</body>
</html>
